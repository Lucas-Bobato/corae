...
export function RestaurantCard({
  ...
  const displayAddress = address || location || "Endereço não disponível";
  
  return (
    <Pressable 
      onPress={onPress} 
      className="w-full bg-white rounded-3xl px-5 py-4 mb-4 border border-gray-100 shadow-sm"
      android_ripple={{ color: '#EAF3D7' }}
    >
